  ...
  return (
    <>
      ...
      >
        ...
        >
          <p>
            На XK HARDCORE у каждого игрока только две жизни.
          </p>
          <p>
            Но вы не остаётесь одни. Если друг попал в беду, у команды есть короткое
            время, чтобы добраться до него и вытащить из опасности.
          </p>
        </motion.div>
      </LandingSection>
